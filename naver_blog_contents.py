...
def cnn():
    ...
    return news_summarize, title_text

# Papago API
def papago_auto(news_summarize):
    request_url = "https://openapi.naver.com/v1/papago/n2mt" #네이버 papago open api 사용
    headers = {"X-Naver-Client-Id": "oK7qjS0jPTSMauAVKdFl", "X-Naver-Client-Secret": "LxfsCsaXJ6"} # id, secret id
